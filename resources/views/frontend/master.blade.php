...
<head>
    ...
    <!-- Video Player CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/css/jquery.mb.YTPlayer.min.css') }}">
    <!-- magnific popup css -->
    ...
    <!-- flaticon2 css  -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/fonts/fonts2/flaticon.css') }}">
    <!-- rsmenu CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/css/rsmenu-main.css') }}">
    <!-- slick theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/css/slick-theme.css') }}">
    <!-- rsmenu transitions CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/css/rsmenu-transitions.css') }}">
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <!-- favicon -->

    <link rel="icon" href="{{ asset('frontend/assets/images/fav1-01.png') }}" type="image/x-icon" />
